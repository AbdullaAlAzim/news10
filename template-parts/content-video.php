...
<ul>
    <li>
        ...
        <div class="card news10-card news10-ctg-card news10-effect-wraper ">
            <div class="news10-card-thumb news10-video">
                ...
                $meta_sermon = get_post_meta(get_the_ID(), '_postsmeta', true);
                 ?>
                <a class="venobox play_btn" data-autoplay="true" data-vbtype="video" href="<?php echo esc_url(risset($meta_sermon['video_post']['url'])); ?>">
        ...
        <div class="news10-list-text">
                        ...
                        <g id="user" transform="translate(-24.165)">
                          <g id="Group_466" data-name="Group 466" transform="translate(26.687)">
                            <g id="Group_465" data-name="Group 465" transform="translate(0)">
                              <path id="Path_845" data-name="Path 845" d="M114.274,0a3.483,3.483,0,1,0,3.483,3.483A3.492,3.492,0,0,0,114.274,0Z" transform="translate(-110.791)" fill="#888"></path>
                            </g>
                          </g>
            ...
            <a href="<?php the_permalink(); ?>" class="link-btn"><?php esc_html_e('Read More','news10'); ?></a>
        </div>
    </li>
