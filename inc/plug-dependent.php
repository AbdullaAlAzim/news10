...
function news10_single_title($arg){

        if ( is_category() ) {
            /* translators: Category archive title. 1: Category name */
            $title = single_cat_title( $arg['cat'], 'news10',false);
        } elseif ( is_tag() ) {
            /* translators: Tag archive title. 1: Tag name */
            $title = single_cat_title( $arg['tag'], 'news10',false);
        } elseif ( is_author() ) {
...
function news10_unit_breadcumb($separator = '') {
    /* === OPTIONS === */
    ...
    $wrap_before    = '<ol class="breadcrumb mb-0" itemscope itemtype="http://schema.org/BreadcrumbList">'; // the opening wrapper tag
